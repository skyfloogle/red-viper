...
static const Patch patches[] = {
    ...
    // The artificial slowdown applied to Test Chamber causes problems in the intro animation.
    // The tilemap of the logo is set up, some additional work is done, and then the animation is applied.
    // Due to the artifical slowdown, a frame advance happens between the setup and the animation.
    // The initial state of the tiles represents the completed logo, so the complete logo shows for 1 frame.
    // This can be worked around by setting the initial tiles to blank.
    {
        .gameid = "PRCHMB",
        .address = 0xdb9dc,
        .size = 16 * 6,
        .original = (const uint8_t[]){
            0xFF, 0xFF, 0x57, 0x55, 0x57, 0x55, 0x57, 0x55, 0x57, 0x55, 0x57, 0x55, 0x57, 0x55, 0x57, 0x55, 
            0xFF, 0xFF, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 
            0x57, 0x55, 0x5D, 0x55, 0x75, 0x55, 0xD5, 0x55, 0x55, 0x57, 0x55, 0x5D, 0x55, 0x75, 0x55, 0xD5, 
            ...
            0x57, 0xD5, 0x55, 0x75, 0x55, 0x5D, 0x55, 0x57, 0xD5, 0x55, 0x75, 0x55, 0x5D, 0x55, 0x57, 0x55, 
        },
        .patched = (const uint8_t[]){
